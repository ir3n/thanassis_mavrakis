      ...
      <div className="relative">
        <div className="container pb-[150px]">
          ...
          <div className="text-lg w-1/2 max-w-[636px]">
            <p>
              I am a UI/UX designer and no code developer based in Athens,
              Greece. I love making websites that look great and are easy for
              everyone to use. But I didn't stop at just designing.
            </p>
            <p>
              I wanted to offer more, so I learned tools like Webflow and Wix
              for building websites without needing to code.{" "}
              <em>
